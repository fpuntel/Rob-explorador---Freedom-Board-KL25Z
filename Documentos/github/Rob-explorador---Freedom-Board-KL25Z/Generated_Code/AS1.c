...
LDD_TDeviceData* AS1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv->SavedISRSettings.isrFunction = _int_install_isr(LDD_ivIndex_INT_UART0, AS1_Interrupt, DeviceDataPrv);
  /* SIM_SCGC4: UART0=1 */
...
void AS1_Deinit(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  (void)_int_install_isr(LDD_ivIndex_INT_UART0, DeviceDataPrv->SavedISRSettings.isrFunction, DeviceDataPrv->SavedISRSettings.isrData);
  /* Disable clock gate */
  /* SIM_SCGC4: UART0=0 */
...
void AS1_Interrupt(LDD_RTOS_TISRParameter _isrParameter)
{
  ...
  AS1_TDeviceDataPtr DeviceDataPrv = (AS1_TDeviceDataPtr)_isrParameter;
